...
// From App Inventor: https://github.com/mit-cml/appinventor-sources
// Modified by Anthony Morphett, awmorp@gmail.com
...
/**
 * Initialise flydown for given workspace
 */
Blockly.Flydown.workspaceInit = function( workspace ) {
  if( !workspace.flydown_ && !workspace.isFlyout ) {
    var flydown = new Blockly.Flydown();
    workspace.flydown_ = flydown;
    var flydownSVG = workspace.flydown_.createDom( Blockly.Flydown.cssClassName_ );
    workspace.svgGroup_.appendChild( flydownSVG );  // (See comment in appinventor flydown.js)
    flydown.init( workspace );
    flydown.autoClose = true;   // Close flydown after selecting a block
  }
}

Blockly.Flydown.cssClassName_ = 'blocklyFlydown';
 ...
 */
Blockly.Flydown.prototype.createDom = function() {
  /*
  <g>
  ...
  */
  this.svgGroup_ = Blockly.createSvgElement('g', {'class': Blockly.Flydown.cssClassName_}, null);
